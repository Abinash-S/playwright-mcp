...
const navigate = defineTool({
  ...
  handle: async (context, params, response) => {
    ...
    const navigateCode = `await page.goto('${params.url}');`;
    
    // Add to script generator with enhanced code
    ...
    // Keep backward compatibility for response
    response.addCode(navigateCode);
