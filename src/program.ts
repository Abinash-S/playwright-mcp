...
program
    ...
    .option('--output-dir <path>', 'path to the directory for session logs and general output files.')
    .option('--script-output-dir <path>', 'path to the directory for generated Playwright scripts.')
